...
class UIScene extends Phaser.Scene {
    ...
    createUIScene(gameScene) {
        ...
        this.pauseButton = new Button(this, 500, 30, 'pauseButton', function(){
        ...
        this.pauseMenu = new Menu(this, 200, 100, 300, 300, 'menuBackground', [
            this.playButton = new Button(this, 50, 50, 'playButton', function(){
...
class MenuScene extends Phaser.Scene {
    ...
    create(){
        this.mainMenu = new Menu(this, 30, 30, config.width-60, config.height-55, 'menuBackground', [
            new Button(this, 295, 60, 'playButton', function(){
